  ...
  .hero-body
    ...
    .has-text-centered
      p.about-paragraph by
        a(
          href="https://vk.com/id222898463"
          target="_blank"
          rel="noopener noreferrer"
        )
          strong  Evgeniy Osinkin
      .about-container
        p.about-paragraph Приложение реализовано с помощью
          a(
        ...
        p.about-paragraph Полное описание доступно в
          a(
            href="https://github.com/ev-osi/web-builder"
            target="_blank"
            rel="noopener noreferrer"
